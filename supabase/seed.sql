...
-- 2. PRODUCTS (Sản phẩm)
INSERT INTO products (name, slug, category_id, type, price, import_price, discount_rate, stock, description, image_url, sku, brand, origin, warranty_info, specifications, images) VALUES
-- Pin Lưu Trữ / Ắc Quy (Chi tiết như ảnh mẫu)
(
    'ẮC QUY ROCKET 12V - 50AH SMF 65B24LS', 'ac-quy-rocket-12v-50ah-smf-65b24ls', (SELECT id FROM categories WHERE slug = 'pin-luu-tru'), 'EQUIPMENT', 
...
(
    'ẮC QUY VARTA 12V - 75AH 100D26R (SILVER DYNAMIC)', 'ac-quy-varta-12v-75ah-100d26r', (SELECT id FROM categories WHERE slug = 'pin-luu-tru'), 'EQUIPMENT', 
    2055000, 1500000, 11, 30, 
...
(
    'Pin Lưu Trữ Lithium UFO 5kWh', 'pin-luu-tru-lithium-ufo-5kwh', (SELECT id FROM categories WHERE slug = 'pin-luu-tru'), 'EQUIPMENT', 
...
('Tấm Pin Năng Lượng Mặt Trời Jinko 550W', 'tam-pin-jinko-550w', (SELECT id FROM categories WHERE slug = 'dien-mat-troi'), 'EQUIPMENT', 2500000, 2000000, 10, 150, 'Tấm pin Jinko Solar hiệu suất cao thế hệ mới nhất.', 'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80', 'JK550-N', 'Jinko Solar', 'Trung Quốc', '12 năm vật lý, 25 năm hiệu suất', '{"Công suất": "550W", "Hiệu suất": "21.3%", "Loại Cell": "Monocrystalline N-type", "Kích thước": "2274 x 1134 x 35 mm"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80", "is_primary": true}]'::jsonb),
...
('Tấm Pin Trina Solar 500W', 'tam-pin-trina-500w', (SELECT id FROM categories WHERE slug = 'dien-mat-troi'), 'EQUIPMENT', 2300000, 1950000, 10, 80, 'Trina Solar 500W chất lượng cao.', 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80', 'TR-500', 'Trina', 'Trung Quốc', '10 năm', '{"Công suất": "500W", "Hiệu suất": "20.8%"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80", "is_primary": true}]'::jsonb),
('Tấm Pin JA Solar 545W', 'tam-pin-ja-545w', (SELECT id FROM categories WHERE slug = 'dien-mat-troi'), 'EQUIPMENT', 2480000, 2150000, 0, 50, 'JA Solar hiệu năng vượt trội.', 'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80', 'JA-545', 'JA Solar', 'Trung Quốc', '12 năm', '{"Công suất": "545W", "Hiệu suất": "21.2%"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80", "is_primary": true}]'::jsonb),
('Tấm Pin AE Solar 450W', 'tam-pin-ae-450w', (SELECT id FROM categories WHERE slug = 'dien-mat-troi'), 'EQUIPMENT', 2150000, 1850000, 0, 45, 'AE Solar nhập khẩu châu Âu.', 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80', 'AE-450', 'AE Solar', 'Đức', '15 năm', '{"Công suất": "450W", "Hiệu suất": "21.0%"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80", "is_primary": true}]'::jsonb),
('Tấm Pin Risen 500W', 'tam-pin-risen-500w', (SELECT id FROM categories WHERE slug = 'dien-mat-troi'), 'EQUIPMENT', 2250000, 1900000, 15, 60, 'Risen Energy tiết kiệm chi phí.', 'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80', 'RS-500', 'Risen', 'Trung Quốc', '10 năm', '{"Công suất": "500W", "Hiệu suất": "20.7%"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80", "is_primary": true}]'::jsonb),
('Tấm Pin Qcells 480W', 'tam-pin-qcells-480w', (SELECT id FROM categories WHERE slug = 'dien-mat-troi'), 'EQUIPMENT', 2400000, 2000000, 5, 0, 'Hanwha Qcells bền bỉ.', 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80', 'QC-480', 'Qcells', 'Hàn Quốc', '12 năm', '{"Công suất": "480W", "Hiệu suất": "20.9%"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80", "is_primary": true}]'::jsonb),
...
('Tấm Pin VSUN 450W', 'tam-pin-vsun-450w', (SELECT id FROM categories WHERE slug = 'dien-mat-troi'), 'EQUIPMENT', 2050000, 1750000, 10, 200, 'VSUN sản xuất tại Việt Nam.', 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80', 'VS-450', 'VSUN', 'Việt Nam', '12 năm', '{"Công suất": "450W", "Hiệu suất": "20.4%"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80", "is_primary": true}]'::jsonb),

-- Biến Tần
('Biến Tần Hybrid Deye 8kW', 'bien-tan-hybrid-deye-8kw', (SELECT id FROM categories WHERE slug = 'bien-tan'), 'EQUIPMENT', 35000000, 28000000, 0, 20, 'Inverter Hybrid Deye 8kW 1 pha, kết nối lưới và lưu trữ.', 'https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=800&q=80', 'DEYE-8K-SG01', 'Deye', 'Trung Quốc', '5 năm tiêu chuẩn', '{"Công suất AC": "8000W", "Pha": "1 Pha", "Hỗ trợ lưu trữ": "Có (Hybrid)", "Điện áp Pin": "48V"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=800&q=80", "is_primary": true}]'::jsonb),
('Biến Tần SMA 5kW', 'bien-tan-sma-5kw', (SELECT id FROM categories WHERE slug = 'bien-tan'), 'EQUIPMENT', 45000000, 38000000, 10, 15, 'SMA Sunny Boy cao cấp.', 'https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=800&q=80', 'SMA-5K', 'SMA', 'Đức', '10 năm', '{"Công suất AC": "5000W", "Pha": "1 Pha"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=800&q=80", "is_primary": true}]'::jsonb),
...
('Biến Tần Growatt 5kW', 'bien-tan-growatt-5kw', (SELECT id FROM categories WHERE slug = 'bien-tan'), 'EQUIPMENT', 22000000, 18000000, 0, 30, 'Growatt MIN 5000TL-X.', 'https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=800&q=80', 'GW-5K', 'Growatt', 'Trung Quốc', '5 năm', '{"Công suất AC": "5000W", "Pha": "1 Pha"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=800&q=80", "is_primary": true}]'::jsonb),

-- Gói & Phần mềm
('Hệ Thống Điện Mặt Trời Áp Mái 5kWp', 'he-thong-dien-mat-troi-ap-mai-5kwp', (SELECT id FROM categories WHERE slug = 'dien-mat-troi'), 'PACKAGE', 65000000, 50000000, 0, 5, 'Trọn gói lắp đặt hệ thống 5kWp cho hộ gia đình (Bao gồm vật tư và nhân công).', 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80', 'PKG-5KWP', 'Nexera', 'Việt Nam', '2 năm trọn gói', '{"Quy mô": "Hộ gia đình", "Sản lượng dự kiến": "600-700 kWh/tháng", "Bao gồm thi công": "Có"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80", "is_primary": true}]'::jsonb),
('Hệ Thống Điện Mặt Trời 10kWp', 'he-thong-dien-mat-troi-10kwp', (SELECT id FROM categories WHERE slug = 'dien-mat-troi'), 'PACKAGE', 120000000, 95000000, 10, 2, 'Trọn gói 10kWp 3 pha.', 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80', 'PKG-10K', 'Nexera', 'Việt Nam', '2 năm', '{"Quy mô": "Biệt thự / Xưởng nhỏ"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&q=80", "is_primary": true}]'::jsonb),
('Phần Mềm Quản Lý Kho Bãi N-WMS', 'phan-mem-quan-ly-kho-bai-n-wms', (SELECT id FROM categories WHERE slug = 'phan-mem-quan-ly'), 'PACKAGE', 15000000, 5000000, 20, 999, 'Giải pháp quản lý kho thông minh tích hợp IoT.', 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80', 'SFT-NWMS', 'Nexera Tech', 'Việt Nam', '12 tháng hỗ trợ kỹ thuật', '{"Nền tảng": "Web/Mobile App", "Số lượng User": "Không giới hạn", "Phân hệ": "Nhập, Xuất, Tồn kho, Báo cáo"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80", "is_primary": true}]'::jsonb),
('Phần Mềm Quản Lý Điện Năng N-EMS', 'phan-mem-quan-ly-dien-n-ems', (SELECT id FROM categories WHERE slug = 'phan-mem-quan-ly'), 'PACKAGE', 25000000, 8000000, 0, 999, 'Hệ thống giám sát điện năng IoT.', 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80', 'SFT-NEMS', 'Nexera Tech', 'Việt Nam', '1 năm', '{"Nền tảng": "Web/App"}'::jsonb, '[{"url": "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80", "is_primary": true}]'::jsonb);
...
(
  (SELECT id FROM orders WHERE note = 'Lắp đặt vào cuối tuần'), 
  (SELECT id FROM products WHERE slug = 'he-thong-dien-mat-troi-ap-mai-5kwp'), 
  1, 65000000, 65000000
),
(
  (SELECT id FROM orders WHERE note = 'Giao giờ hành chính'), 
  (SELECT id FROM products WHERE slug = 'tam-pin-jinko-550w'), 
  1, 2500000, 2500000
),
(
  (SELECT id FROM orders WHERE note = 'Cần xuất hóa đơn VAT công ty'), 
  (SELECT id FROM products WHERE slug = 'bien-tan-hybrid-deye-8kw'), 
  2, 35000000, 70000000
),
(
  (SELECT id FROM orders WHERE note = 'Cần xuất hóa đơn VAT công ty'), 
  (SELECT id FROM products WHERE slug = 'pin-luu-tru-lithium-ufo-5kwh'), 
  2, 20000000, 40000000
);
